...
// Need to figure out what this function is actually doing.
...
int main(int argc, char *argv[])
{
	...
	TinyMidiLoader = tml_load_filename("..\\..\\original examples\\venture.mid"); //REPLACE WITH PATH TO THE MIDI FILE
	if (!TinyMidiLoader)
	{
	...
	g_TinySoundFont = tsf_load_filename("..\\..\\soundfonts\\florestan-subset.sf2"); //REPLACE WITH PATH TO THE SOUNDFONT FILE
	if (!g_TinySoundFont)
	{
