...
namespace AudioSynthesis.Synthesis
{
    ...
    public struct MidiMessage
    {
        ...
        public MidiMessage(byte channel, byte command, byte data1, byte data2)
            : this(0, 0, 0, channel, command, data1, data2) { }
        public MidiMessage(int delta, int originalDelta, int originalTrack, byte channel, byte command, byte data1, byte data2)
        {
